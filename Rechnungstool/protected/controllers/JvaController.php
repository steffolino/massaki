...
class JvaController extends Controller
{
	...
	public function actionSaveJVAEditForm(){
		...
		if(isset($_POST['data'])){
			...
			$jvaColEk1 = $_POST['data'][42];
			$jvaColEk2 = $_POST['data'][43];
			$jvaColEk3 = $_POST['data'][44];
			$jvaColEk4 = $_POST['data'][45];
			$jvaColEk5 = $_POST['data'][46];
			$jvaColEk6 = $_POST['data'][47];
			$jvaColEk7 = $_POST['data'][48];
			$jvaColEk8 = $_POST['data'][49];
			$jvaColEk9 = $_POST['data'][50];
			$jvaPrintAmountIk = $_POST['data'][51];
			$jvaPrintAmountMemmel = $_POST['data'][52];
			$jvaPrintAmountLoehne = $_POST['data'][53];
			$jvaPrintAmountWitte = $_POST['data'][54];
			$jvaPrintAmountEk = $_POST['data'][55];
			//echo $jvaCol9;
			...
			$jvaModel->updateJva($jvaName,$jvaNameExt,$jvaAddress,$jvaFooter,$jvaCustName,$jvaCustNameDesc,$jvaColIk1,$jvaColIk2,$jvaColIk3,$jvaColIk4,$jvaColIk5,$jvaColIk6,'0% MwSt','7% MwSt','19% MwSt','Gesamt 0%','Gesamt 7%','Gesamt 19%',$jvaColMemmel1,$jvaColMemmel2,$jvaColMemmel3,$jvaColMemmel4,$jvaColMemmel5,$jvaColMemmel6,'0% MwSt','7% MwSt','19% MwSt','Gesamt 0%','Gesamt 7%','Gesamt 19%',$jvaColLoehne1,$jvaColLoehne2,$jvaColLoehne3,$jvaColLoehne4,$jvaColLoehne5,$jvaColLoehne6,'0% MwSt','7% MwSt','19% MwSt','Gesamt 0%','Gesamt 7%','Gesamt 19%',$jvaColWitte1,$jvaColWitte2,$jvaColWitte3,$jvaColWitte4,$jvaColWitte5,$jvaColWitte6,'0% MwSt','7% MwSt','19% MwSt','Gesamt 0%','Gesamt 7%','Gesamt 19%',$jvaColEk1,$jvaColEk2,$jvaColEk3,$jvaColEk4,$jvaColEk5,$jvaColEk6,'0% MwSt','7% MwSt','19% MwSt','Gesamt 0%','Gesamt 7%','Gesamt 19%',$jvaPrintAmountIk ,$jvaPrintAmountMemmel ,$jvaPrintAmountLoehne ,$jvaPrintAmountWitte,$jvaPrintAmountEk);
